...
Weekly Sunday email digest. Newsletter ingest (Gmail IMAP) + job-intel scrape (Apify -> RSS fallback) -> OpenClaw LLM summarization -> tiered HTML email via Gmail SMTP. Runs on VPS via cron.
